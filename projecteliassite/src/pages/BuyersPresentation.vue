<template>
    <q-page class="flex flex-center">
        <div id="whycompass">
            ...
            <iframe v-else src="https://www.icloud.com/keynote/0BPDhl9OgapgmQp9st5J2rreA?embed=true" width="100%" :height="embedHeight" frameborder="0" allowfullscreen="1" referrer="no-referrer"></iframe>
        </div>
    </q-page>
</template>
